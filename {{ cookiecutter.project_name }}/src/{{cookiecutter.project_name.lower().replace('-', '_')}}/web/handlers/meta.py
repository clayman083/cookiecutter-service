...
from {{ cookiecutter.project_name.lower().replace('-', '_') }}.metrics import registry
from {{ cookiecutter.project_name.lower().replace('-', '_') }}.web.handlers import json_response
    ...
    return json_response(
        {
            ...
            "project": request.app["distribution"].name,
